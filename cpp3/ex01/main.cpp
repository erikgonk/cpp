...
/*   Updated: 2024/10/23 09:38:24 by erigonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
    ...
    std::cout << MAGENTA << "Energy Points: " << scavTrapDefault.getEnergyPoints() << RESET << std::endl;
    ...
    std::cout << MAGENTA << "Energy Points: " << customScavTrap.getEnergyPoints() << RESET << std::endl;
